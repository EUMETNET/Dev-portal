...
CONSUMERS: list = [
    {
        ...
        "plugins": {
            "key-auth": {"key": "$secret://vault/1/00000000000000000001a/auth_key" }},
    ...
    },
    {
        ...
        "plugins": {
            "key-auth": {"key": "$secret://vault/1/00000000000000000002b/auth_key" }},
    ...
    },
    {
        ...
        "plugins": {
            "key-auth": {"key": "$secret://vault/1/00000000000000000003c/auth_key" }},
    ...
    },
    {
        ...
        "plugins": {
            "key-auth": {"key": "$secret://vault/1/00000000000000000004d/auth_key" }},
