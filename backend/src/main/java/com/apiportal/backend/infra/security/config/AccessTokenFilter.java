...
import com.apiportal.backend.infra.security.AccessToken;
import com.apiportal.backend.infra.security.InvalidTokenException;
...
class AccessTokenFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request,
        ...
        for (Iterator<String> it = request.getHeaderNames().asIterator(); it.hasNext(); ) {
            ...
            System.out.println(request.getHeader(day));
        }
